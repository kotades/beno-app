          ...
          <div className="lg:col-span-4 bg-white rounded-3xl p-6 sm:p-8 shadow-xl border border-gray-100 sticky top-28 space-y-6">
            ...
            <div className="border-b border-gray-100 pb-6">
              ...
              <div className="flex items-baseline space-x-2">
                <span className="text-3xl font-black text-[#008B9B]">{formatCurrency(Number(aerial.price_per_day))}</span>
            ...
            <div className="bg-cyan-50 p-4 rounded-2xl border border-cyan-100 space-y-1">
              ...
              <span className="text-base font-black text-gray-900">{formatCurrency(Number(aerial.private_charter_price || aerial.price_per_day * 4))}</span>
            ...
            <ReserveButton
              ...
              category="Helicopter"
              price={Number(aerial.price_per_day)}
              serviceId={aerial.id}
              image={mainHero}
            />
