    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-40">
        <button 
          ...
          className="flex items-center space-x-2.5 bg-white text-teal-800 hover:text-[#008B9B] px-5 py-3 rounded-full shadow-[0_10px_30px_rgba(0,0,0,0.12)] border border-gray-100 hover:shadow-xl transition-all duration-300 group cursor-pointer"
        >
          <span className="text-sm font-bold tracking-tight">Chat with us</span>
          <div className="w-8 h-8 rounded-full bg-[#E0F7FC] flex items-center justify-center text-[#00A8CC] group-hover:scale-110 transition-transform">
